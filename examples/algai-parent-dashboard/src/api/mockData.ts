...
export const demoLearningSummaries: StudentLearningSummary[] = [
  {
    ...
    subjects: [
      {
        ...
        confidence: "growing",
        progressNote:
          "Mia is using more complete sentences when she retells a passage.",
        evidence: [
          "Two reading reflections completed",
          "One teacher conference note",
        ],
      },
      {
        subject: "Math",
        ...
        progressNote:
          "The answer is often close, but the written steps need more care.",
      ...
      },
      {
        ...
        confidence: "growing",
        progressNote:
          "She asked one clarifying question during group work this week.",
    ...
    strengths: [
      {
        ...
        explanation:
          "Mia is moving from short answers to clearer explanations of what happened in a passage.",
        parentAction:
          "Ask her to tell you one detail that changed how she understood the story.",
      ...
      },
      {
        ...
        explanation:
          "A small outline is making her writing calmer and easier to follow.",
        parentAction:
          "Celebrate the outline before reading the final paragraph.",
        attentionLevel: "steady",
        evidenceCount: 2,
      },
    ],
    practiceNeeds: [
      {
        ...
        explanation:
          "Mia understands many parts of the work, but skipped steps make it harder to see where support is needed.",
        parentAction:
          "Pick one math problem and ask her to explain the first step out loud.",
      ...
      },
      {
        ...
        explanation:
          "The work is stronger when the routine starts before she is tired.",
    ...
    monitorAreas: [
      {
        ...
        explanation:
          "This is a pattern to watch, not a reason to worry. Short breaks may help her finish with more care.",
        parentAction:
          "Notice whether a two-minute reset helps before the final question.",
        attentionLevel: "watch",
        evidenceCount: 2,
      },
      {
        ...
        explanation:
          "She asked for help once this week. More examples will show whether this is becoming comfortable.",
    ...
    supportPlan: [
      {
        ...
        explanation:
          "Mia responds best when the support names one thing she did well and one thing to try next.",
        parentAction:
          "Use this sentence: I noticed the step you wrote. Let us add the next one together.",
        attentionLevel: "steady",
        evidenceCount: 2,
      },
      {
        ...
        explanation:
          "A predictable start makes practice feel less like a surprise.",
    ...
    recentChanges: [
      ...
      },
      {
        ...
        detail:
          "She completed the first two parts carefully, then rushed the final part.",
        attentionLevel: "watch",
      },
      {
        id: "change-homework",
        ...
        detail:
          "The work had fewer skipped steps when practice started before dinner.",
        attentionLevel: "steady",
      },
    ],
    learningReview: {
    ...
    recommendedNextStep: {
      ...
      detail:
        "After each reading time, ask Mia to share one detail that changed her understanding.",
      whyNow:
        "Reading confidence is growing, and short shared practice can strengthen the pattern.",
    },
    decisionQuality: {
      supportingEvidence: [
      ...
      nextBestEvidence: {
        ...
        whyItMatters:
          "It would show whether the focus support changes the actual work, not just the mood.",
        expectedImpact:
          "Clarifies whether home practice should add short breaks before harder problems.",
      },
    },
    evidenceHistory: [
      {
  ...
  },
  {
    ...
    subjects: [
      {
        ...
        confidence: "steady",
        progressNote:
          "Noah is spotting patterns more quickly when he names each step.",
        evidence: [
          "Pattern activity completed",
          "One reflection saved in AlgAI",
        ],
      },
      {
        subject: "Reading",
    ...
    strengths: [
      {
        ...
        explanation:
          "Noah is using more precise words when he explains what changes in a sequence.",
    ...
    practiceNeeds: [
      {
        ...
        parentAction:
          "Point to the sentence and ask what word would make sense there.",
        attentionLevel: "watch",
        evidenceCount: 1,
      },
    ],
    ...
    supportPlan: [
      {
        ...
        explanation:
          "Saying the rule helps Noah check whether the pattern still works.",
    ...
    learningReview: {
      ...
      stillNeedsProof: [
        "Whether the reading pause carries into longer passages.",
      ],
    },
    recommendedNextStep: {
      ...
      whyNow:
        "The evidence shows that spoken rules help him check his thinking.",
    },
    decisionQuality: {
      supportingEvidence: [
      ...
      lessons: ["Spoken rules help Noah check his thinking before answering."],
      nextActions: [
      ...
      nextBestEvidence: {
        ...
        whyItMatters:
          "It would show whether the pattern language survives a small increase in difficulty.",
        expectedImpact:
          "Helps decide whether to keep practicing the same skill or move on.",
      },
    },
    evidenceHistory: [
      {
