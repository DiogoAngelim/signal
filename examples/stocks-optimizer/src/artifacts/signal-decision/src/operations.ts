...
export const DECISION_OPERATION_DEFINITIONS: readonly DecisionOperationDefinition[] = [
  ...
  },
  {
    ...
    version: "v1",
    description: "Evaluate observation and module evidence into a decision record.",
    idempotent: true,
    replaySafe: true,
  },
  {
    ...
    version: "v1",
    description: "Replay a previous decision with original or current knowledge.",
    idempotent: true,
    replaySafe: true,
  },
  {
    ...
    version: "v1",
    description: "Record an outcome and derive trust and calibration feedback.",
    idempotent: true,
    replaySafe: true,
  },
  {
  ...
  },
  {
    ...
    version: "v1",
    description: "Emitted when coherence, simulation, or wisdom blocks action.",
    idempotent: true,
    replaySafe: true,
  },
  {
...
export function registerDecisionOperations(registry: DecisionRegistryLike): DecisionOperationDefinition[] {
