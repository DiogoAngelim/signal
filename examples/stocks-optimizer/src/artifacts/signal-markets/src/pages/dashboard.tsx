...
export default function Dashboard() {
  ...
  const decisionRawMetrics = [
    ...
    { label: "Belief Freshness", value: fmtPlainPct(primaryDecisionOpportunity?.learning?.beliefFreshness?.freshness, 0) },
    ...
    { label: "Process Quality", value: fmtPlainPct(primaryDecisionOpportunity?.learning?.processQuality?.processQualityScore, 0) },
