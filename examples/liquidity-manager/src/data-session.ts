import type { BalanceSnapshot, BankConnection, ConnectionResult, FinancialDataConnector, RawTransaction } from "./models.js";
...
export class FinancialDataSession {
  ...
  async connect(connector: FinancialDataConnector, input: unknown): Promise<ConnectionResult> {
    ...
    this.rawTransactions = await connector.fetchTransactions(result.connection.id);
    return result;
  }
