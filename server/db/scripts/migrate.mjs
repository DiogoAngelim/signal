...
const migrationPath = path.resolve(__dirname, "../migrations/0001_signal_decision_memory.sql");

if (!process.env.DATABASE_URL) {
  console.error("DATABASE_URL is required to run Signal decision-memory migrations.");
  process.exit(1);
}
