...
export const docsPages: DocsPageEntry[] = [
  {
    ...
    title: "Concepts",
    summary:
      "The core Signal concepts explain how queries, mutations, events, idempotency, versioning, and replay fit together.",
    primaryLabel: "Open queries",
    primaryHref: "/docs/concepts/queries",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/concepts/queries",
    body: bullets([
  ...
  },
  {
    ...
    title: "Queries",
    summary:
      "Queries are read-only operations. They must not change durable state and they must be safe to retry.",
  ...
  },
  {
    ...
    title: "Mutations",
    summary:
      "Mutations are explicit state-changing commands. They may emit events and they must declare idempotency mode.",
    primaryLabel: "Open events",
    primaryHref: "/docs/concepts/events",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/concepts/mutations",
    body: bullets([
      "Use versioned names.",
  ...
  },
  {
    ...
    title: "Events",
    summary:
      "Events are immutable facts. Consumers must tolerate duplicates and replay, and the protocol does not assume a global order.",
  ...
  },
  {
    ...
    title: "Idempotency",
    summary:
      "Mutation retries use idempotency keys plus a normalized payload fingerprint to return the same logical result or a conflict.",
    primaryLabel: "Open versioning",
    primaryHref: "/docs/concepts/versioning",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/concepts/idempotency",
    body: bullets([
  ...
  },
  {
    ...
    title: "Versioning",
    summary:
      "Breaking changes require a new version suffix in the operation name.",
    primaryLabel: "Open order and replay",
    primaryHref: "/docs/concepts/order-and-replay",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/concepts/versioning",
    body: bullets([
  ...
  },
  {
    ...
    summary:
      "Signal does not promise global ordering. Consumers must process events so duplicates and replays are safe.",
    primaryLabel: "Open the envelope",
    primaryHref: "/docs/reference/envelope",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/concepts/order-and-replay",
    body: bullets([
  ...
  },
  {
    ...
    title: "Envelope",
    summary:
      "The envelope normalizes every Signal message with required protocol fields and optional delivery, auth, context, and meta data.",
    primaryLabel: "Open capabilities",
    primaryHref: "/docs/reference/capabilities",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/reference/envelope",
    body: codeBlock(`{
  "protocol": "signal.v1",
  "kind": "mutation",
  ...
  },
  {
    ...
    title: "Capabilities",
    summary:
      "A capability document declares supported queries, mutations, published events, subscribed events, and bindings.",
    primaryLabel: "Open errors",
    primaryHref: "/docs/reference/errors",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/reference/capabilities",
    body: bullets([
  ...
  },
  {
    ...
    title: "Errors",
    summary:
      "Signal errors use a machine-readable code, a retryable flag when relevant, and structured detail that clients can inspect.",
  ...
  },
  {
    ...
    title: "Conformance",
    summary:
      "Conformance explains what a Signal-compatible system must implement, what is optional, and what remains out of scope.",
    primaryLabel: "Open quickstart",
    primaryHref: "/docs/guides/quickstart",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/reference/conformance",
    body: bullets([
  ...
  },
  {
    ...
    summary:
      "Register a read-only operation with an input schema and a result schema, then expose it through a binding.",
    primaryLabel: "Open mutation guide",
    primaryHref: "/docs/guides/define-your-first-mutation",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/guides/define-your-first-query",
    body: bullets([
  ...
  },
  {
    ...
    summary:
      "Register a state-changing command, declare idempotency, and emit events only after the write succeeds.",
    primaryLabel: "Open event guide",
    primaryHref: "/docs/guides/emit-and-consume-events",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/guides/define-your-first-mutation",
    body: bullets([
  ...
  },
  {
    ...
    summary:
      "Emit immutable facts from mutations and consume them in a replay-safe way with duplicate tolerance.",
    primaryLabel: "Open HTTP binding guide",
    primaryHref: "/docs/guides/http-binding",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/guides/emit-and-consume-events",
    body: bullets([
  ...
  },
  {
    ...
    title: "HTTP Binding",
    summary:
      "Use the HTTP binding to execute queries and mutations over a concrete transport without changing protocol semantics.",
    primaryLabel: "Open in-process guide",
    primaryHref: "/docs/guides/in-process-runtime",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/guides/http-binding",
    body: codeBlock(`POST /signal/mutation/payment.capture.v1
{
  ...
  },
  {
    ...
    summary:
      "Use the in-process binding for local execution, tests, and examples where transport separation is not needed.",
    primaryLabel: "Open payment example",
    primaryHref: "/docs/examples/payment-capture-flow",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/guides/in-process-runtime",
    body: bullets([
  ...
  },
  {
    ...
    summary:
      "Capture a payment with retry-safe mutation handling and emit a payment.captured.v1 event.",
    primaryLabel: "Open escrow example",
    primaryHref: "/docs/examples/escrow-release-flow",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/examples/payment-capture-flow",
    body: bullets([
      "same key + same payload => same logical result",
      "same key + different payload => conflict",
  ...
  },
  {
    ...
    summary:
      "Release escrow after state checks, then publish escrow.released.v1 so downstream systems can react.",
    primaryLabel: "Open onboarding example",
    primaryHref: "/docs/examples/user-onboarding-flow",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/examples/escrow-release-flow",
    body: bullets([
  ...
  },
  {
    ...
    summary:
      "Onboard a user with explicit command handling and publish user.onboarded.v1 as the immutable completion event.",
    primaryLabel: "Open quickstart",
    primaryHref: "/docs/guides/quickstart",
    canonicalHref:
      "https://diogoangelim.github.io/signal/docs/examples/user-onboarding-flow",
    body: bullets([
